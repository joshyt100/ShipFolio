    ...
    <section id="faq" className="relative bg-muted/5 py-24 md:py-32">
      ...
      <div className="container mx-auto max-w-screen-xl">
        <div className="mx-auto mb-16 max-w-[58rem] text-center space-y-4">
          <div className="rounded-full border border-border/40 bg-background/80 px-3 py-1 text-xs font-medium text-primary mx-auto w-fit">
            FAQ
          </div>
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          {faqs.map(({ q, a, color }) => (
            <div
              key={q}
              className="group relative rounded-xl border border-border/40 bg-background p-6 shadow-md hover:-translate-y-1 hover:shadow-xl duration-300"
            >
